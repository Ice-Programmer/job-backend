...
public class PrincipalUtil {
    ...
    /**
     * 1. 用户账号不能为纯数字 2. 由数字字母下划线 4-16位组成
     */
    public static final String USER_ACCOUNT_REGEXP = "(?!\\d+$)([a-zA-Z0-9]{4,16})";
     ...
     * @return 匹配结果
     */
    public static boolean isUserAccount(String value) {
        return isMatching(USER_ACCOUNT_REGEXP, value);
    }
