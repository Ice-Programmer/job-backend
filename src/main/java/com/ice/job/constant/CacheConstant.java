...
public interface CacheConstant {
     ...
     * 学校列表类型
     */
    String SCHOOL_LIST_KEY = "others:school:list";
    Long SCHOOL_LIST_TTL = 30 * 24 * 60 * 60L;    // 30 day

    /**
     * 专业列表类型
     */
    String MAJOR_LIST_KEY = "others:major:list";
    Long MAJOR_LIST_TTL = 30 * 24 * 60 * 60L;    // 30 day
