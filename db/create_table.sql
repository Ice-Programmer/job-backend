...
(
    ...
    userPhone    varchar(512)                           not null comment '手机',
    userName     varchar(256)                           null comment '用户昵称',
    userAvatar   varchar(1024)                          null comment '用户头像',
    userRole     varchar(256) default 'employee'        not null comment '用户角色：employee/employer/admin',
...
(
    ...
    education         int          default 0                 not null comment '最高学历',
    majorId           bigint                                 not null comment '专业id',
    schoolId          bigint                                 not null comment '学校id',
    positionIds       varchar(1024)                          not null comment '行业期望',
